...
import Viewvoucher from "./page/Voucher/viewvoucher";
import Indexbanner from "./page/Banner/indexbanner";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <Routes>
              ...
              <Route path="/Updatevoucher/:id_voucher" element={<Editvoucher/>} />
              <Route path="/Viewvoucher/:id_voucher" element={<Viewvoucher/>} />

              <Route path="/Indexbanner" element={<Indexbanner/>} />
              <Route path="/Createbanner" element={<Createbanner/>} />
              <Route path="/Updatebanner/:id_banner" element={<Editbanner/>} />
            </Routes>
            </div>
