...
export default function Indexhoadon() {
    ...
    const loadData =  async() =>{
        const response = await axios.get("/api/getalldonhang");
        ...
        const handleSearch = async (e) => {
            ...
            try {
                const response = await axios.get(`/api/searchhd/${searchTerm}`);
                setData(response.data);
            } catch (error) {
...
const deleteDH = async (ma_don_hang) => {
    if (window.confirm("Bạn có muốn xóa danh mục này không?")) {
        try {
            await axios.delete(`/api/deletedonhang/${ma_don_hang}`);
        ...
        const handleDateSearch = async (e) => {
            ...
            if (!selectedDate) {
                ...
                try {
                    const response = await axios.get(`/api/gethoadon/${selectedDate}`);
                    setData(response.data);
                } catch (error) {
        ...
        const handleStatusSearch = async (e) => {
            ...
            if (!selectedStatus) {
              ...
              try {
                const response = await axios.get(`/api/gethoadon/trangthai/${selectedStatus}`);
                setData(response.data);
              } catch (error) {
